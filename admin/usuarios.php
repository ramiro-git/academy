...
<body>
    ...
    <h3>Cantidad de alumnos registrados: <?= $cantAlumnosRegistradosUsuarios ?></h3>
    <h3>Cantidad de alumnos registrados el último mes: <?= $cantAlumnosRegistradosNuevos ?></h3>
    ...
    <div class="bloques">
        ...
        if ($total_paginas > 1) {
            ...
            for ($i = 1; $i <= $total_paginas; $i++) {
                if ($pagina_actual == $i) echo "<a class='active' href='?pagina=$i'>$i</a>";
